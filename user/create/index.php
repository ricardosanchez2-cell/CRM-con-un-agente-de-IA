...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="CRM | Registro" />
    ...
    <div class="register-box">
      ...
      <div class="card card-outline card-primary">
        <div class="card-header">
          ...
          >
            <h1 class="mb-0"><b>¡Registrate!</b></h1>
          </a>
        </div>
        <div class="card-body register-card-body">
          <p class="register-box-msg">Crear un nuevo usuario</p>

          <form action="../index3.html" method="post">
            <div class="input-group mb-1">
              <div class="form-floating">
                <input id="registerFullName" type="text" class="form-control" placeholder="" />
                <label for="registerFullName"> Nombre y apellido</label>
              </div>
          ...
          <div class="social-auth-links text-center mb-3 d-grid gap-2">
            <p>- Otros métodos para crear un usuario -</p>
            <a href="#" class="btn btn-primary">
              <i class="bi bi-facebook me-2"></i> Iniciar sesion con Facebook
            </a>
          ...
          <p class="mb-0">
            <a href="login.html" class="link-primary text-center"> Ya tengo una cuenta </a>
          </p>
        </div>
        <!-- /.register-card-body -->
      </div>
