...
<head>
    ...
    <title> CRM | Inicio Sesión</title>

    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=yes" />
    <meta name="color-scheme" content="dark dark" />
    <meta name="theme-color" content="#414346" media="(prefers-color-scheme: dark)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="AdminLTE 4 | Login" />
    <meta name="author" content="RickSanchez" />
    ...
    <meta name="supported-color-schemes" content="dark dark" />
    ...
    <style>
        body.login-page {
            ...
            -webkit-filter: grayscale(100%) !important; /* Soporte para navegadores basados en WebKit (Safari, etc.) */
        }
        /* Asegura que los campos de formulario e inputs también hereden Nunito */
        .form-control, .form-floating label, .btn, h1 {
            font-family: 'Nunito', sans-serif !important;
        }
    </style>
</head>
    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <a href="../login/" class="link-dark text-center link-offset-2 link-opacity-100 link-opacity-50-hover">
                    <h1 class="mb-0"><b>Bienvenid@!</b></h1>
                </a>
            </div>
             
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Usuario y/o contraseña incorrectos!</strong> Revisa tus credenciales.
            ...
            <div class="card-body login-card-body">
                ...
                <form action="validate/" method="post">
                    <div class="input-group mb-1">
                        <div class="form-floating">
                            <input id="loginEmail" type="email" class="form-control" value="" placeholder="Ingrese su email" name="username" />
                ...
                <div class="social-auth-links text-center mb-3 d-grid gap-2">
                    <p>- Otros métodos de inicio de sesión -</p>
                ...
                <p class="mb-0">
                    <a href="../create/" class="text-center"> Registrate como nuevo usuario </a>
                </p>
            </div>
        </div>
    </div>
